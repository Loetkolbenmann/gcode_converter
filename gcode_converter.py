...
def gcode_to_array(path):
    ...
    current_params = [0 for i in range(5)]  #Keep track of current parameters [X,Y,Z,E,F] to fill gaps 
    ...
    for printpath in printpaths: 
        ...
        for line in printpath:
            ...
            x = y = z = e = f = None
            for param in params:
                #look for Parameter flags and read them out, if the line doesn't contain a new parameter, use the most recent one 
